...
This project teaches hands-on data lake engineering using Delta Lake and Polars on AWS S3. Through progressive POC scripts, learners build a complete mental model of modern lakehouse architecture — from basic reads/writes to a full Bronze-to-Silver ETL pipeline — all in pure Python, no Spark required.
